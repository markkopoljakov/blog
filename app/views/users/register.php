                ...
                <div class="card-body">
                    <form class="form" role="form" action="<?php echo URLROOT.'/users/register'?>" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control <?php echo (!empty($data['name_err'])) ? 'is-invalid' : ''; ?>" id="name" placeholder="Full name" name="name" value="<?php echo (!empty($data['name'])) ? $data ['name']: ''?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control <?php echo (!empty($data['password_confirm_err'])) ? 'is-invalid' : ''; ?>" id="confirm_password" placeholder="Confirm Password" name="confirm_password" value="<?php echo (!empty($data['confirm_password'])) ? $data ['confirm_password']: ''?>">
